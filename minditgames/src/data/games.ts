...
export const games: Game[] = [
  {
    ...
    tagline:
      "Sort groceries, organize shelves, solve puzzles & build your supermarket!",
    category: "Puzzle",
    description:
    ...
    screenshots: [
      {
        src: "/images/games/grocery-sort/screenshot-1.jpg",
        alt: "Grocery Sort gameplay screenshot 1",
      },
      {
        src: "/images/games/grocery-sort/screenshot-2.jpg",
        alt: "Grocery Sort gameplay screenshot 2",
      },
      {
        src: "/images/games/grocery-sort/screenshot-3.jpg",
        alt: "Grocery Sort gameplay screenshot 3",
      },
      {
        src: "/images/games/grocery-sort/screenshot-4.jpg",
        alt: "Grocery Sort gameplay screenshot 4",
      },
    ],
    rating: undefined,
    ...
    downloads: undefined,
    playStoreUrl:
      "https://play.google.com/store/apps/details?id=com.minditgames.grocery.sort.shopping.puzzle",
    appStoreUrl: "#",
    accent: "orange",
    isNew: true,
  },
  {
    ...
    tagline:
      "Enjoy ASMR house cleaning — clean, fix & decorate everything in cleaning ASMR",
    category: "Simulation",
    description:
    ...
    screenshots: [
      {
        src: "/images/games/home-cleaning-asmr/screenshot-1.jpg",
        alt: "Home Cleaning ASMR gameplay screenshot 1",
      },
      {
        src: "/images/games/home-cleaning-asmr/screenshot-2.jpg",
        alt: "Home Cleaning ASMR gameplay screenshot 2",
      },
      {
        src: "/images/games/home-cleaning-asmr/screenshot-3.jpg",
        alt: "Home Cleaning ASMR gameplay screenshot 3",
      },
      {
        src: "/images/games/home-cleaning-asmr/screenshot-4.jpg",
        alt: "Home Cleaning ASMR gameplay screenshot 4",
      },
    ],
    rating: undefined,
    ratingCount: undefined,
    downloads: "1K+",
    playStoreUrl:
      "https://play.google.com/store/apps/details?id=com.minditgames.cleaning.game",
    appStoreUrl: "#",
    accent: "blue",
  },
];
